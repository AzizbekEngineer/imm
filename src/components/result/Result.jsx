...
const stats = [
    { id: 1, icon: <TrophyIcon />, value: "15+", label: "Years of experience", tone: "accent" },
    { id: 2, icon: <FactoryIcon />, value: "500K", label: "Production capacity", tone: "accent" },
    { id: 3, icon: <TeamIcon />, value: "250", label: "Team members", tone: "dark" },
    { id: 4, icon: <CubeIcon />, value: "40", label: "Product categories", tone: "dark" },
];
            ...
            <ul className="result__list container">
                {stats.map((item) => (
                    <li className="result__item" key={item.id}>
                        <span className={`result__icon result__icon--${item.tone}`}>{item.icon}</span>
